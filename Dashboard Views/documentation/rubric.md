...
│       ├── app.py             # نقطة الانطلاق الرئيسية لتشغيل السيرفر وإعدادات التطبيق
│       ├── database/          # مجلد إدارة وإعداد قواعد البيانات
│       │   ├── create_tables/     # سكريبتات وإنشاء الجداول والتعامل مع البنية
│       │   └── initial_data/      # البيانات الأولية والابتدائية لإجهاد أو تهيئة النظام
│       ├── static/            # المرفقات الثابتة الخاصة بالواجهات
│       │   ├── css/
│       │   │   └── style.css  # ملف التنسيقات والأشكال البصرية للموقع وتنسيقات RTL
│       │   └── images/        # الصور والشعارات المستخدمة (flag, logo, q1, q2, q4, ruins)
│       ├── translations/      # ملفات الترجمة والتدويل (i18n) للغة العربية والإنجليزية
│       │   ├── ar.json        # نصوص الترجمة باللغة العربية
│       │   └── en.json        # نصوص الترجمة باللغة الإنجليزية
│       ├── templates/         # واجهات المستخدم (Jinja2 HTML Templates)
│       │   ├── layout.html    # الهيكل العام الموحد (Header, Navigation, Footer)
│       │   ├── home.html      # المؤشرات الرئيسية (KPIs) والسلايدر والواجهة الترحيبية
│       │   └── resume.html    # السجل الشامل والشات الذكي المدمج وتحليل البيانات
│       └── utils/             # الأدوات المساعدة وملفات المنطق البرمجي
│           ├── __init__.py    # تهيئة حزمة الأدوات والوظائف البرمجية
│           ├── database.py    # إدارة الاتصالات وتنفيذ العمليات على قاعدة البيانات
│           ├── llm.py         # محرك معالجة اللغات الطبيعية والاستفسارات الذكية والخبراء
│           ├── routes.py      # معالجة المسارات والربط الحقيقي مع Kobo API والشات والجداول
│           └── socket_events.py # معالجة الأحداث الحية والاتصال اللحظي (Socket.io)
└── README.md                  # التوثيق الرئيسي للبرمجية وكيفية التثبيت والتشغيل
...
"كم عدد الأسر في المخيمات؟"

"ما هي احتياجات ذوي الاحتياجات الخاصة؟"

"قارن بين الجنوب والوسطى"

باللغة الإنجليزية:

"How many elderly people are registered?"

"Show me families in camps and tents"

"Compare south and middle regions"
